...
<a href="https://multistem.000webhostapp.com/statistika-igre?id=<?php echo $id; ?>" class="btn btn-success shadow-lg p-3 mb-5" style="margin:auto;width:50%;border-radius:50px;color:black;">Pregled aktivnosti</a>
</div>
