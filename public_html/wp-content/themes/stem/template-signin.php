...
if(isset($_POST['LoginV']) || isset($_POST['LoginD'])) {
  ...
  $site = site_url();
   ...
   $serverime = "localhost";
  $Username = "id16327517_root";
  $passw = "Sifra123456.";
  $imeBaze = "id16327517_wpress1";
    ...
    if(mysqli_num_rows($qv) > 0)  
           {  
                ...
                {  
                     ...
                     {  
                      ...
                      $_SESSION['prioritet'] = $row['prioritet'];
                       ...
                       echo '<script type="text/javascript">
                         window.location.replace("https://multistem.000webhostapp.com/");
                      </script>';
                     ...
                     {  
                           echo '<script type="text/javascript">
                         window.location.replace("https://multistem.000webhostapp.com/login?error=WRONG_PASSWORD");
                      </script>';
                    ...
                    echo '<script type="text/javascript">
                         window.location.replace("https://multistem.000webhostapp.com/login?error=USER_DOES_NOT_EXIST");
                      </script>';
              ...
              echo '<script type="text/javascript">
                         window.location.replace("https://multistem.000webhostapp.com/login?error=ERROR");
                      </script>';
           ...
           {  
                ...
                {  
                     ...
                     {  
                      ...
                      echo '<script type="text/javascript">
                         window.location.replace("https://multistem.000webhostapp.com/igrice");
                      </script>';
