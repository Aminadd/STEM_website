     ...
     if(isset($_POST['registracijaV'])) {
       ...
       if (!preg_match("/^([a-zA-Z' ćčČĆ]{6,30}+)$/",$imeprezime) && !filter_var($email, FILTER_VALIDATE_EMAIL))
       {
             echo '<script type="text/javascript">
                window.location.replace("https://multistem.000webhostapp.com/registracija?error=INVALID_INFOR");
             </script>';
       ...
       $upitV = "INSERT into korisnici (imeprezime, username, lozinka, prioritet) VALUES
        ...
        else
        {
            ...
            echo '<script type="text/javascript">
                window.location.replace("https://multistem.000webhostapp.com/registracija?error=ERROR");
             </script>';
